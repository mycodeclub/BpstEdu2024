...
{
    /// <inheritdoc />
    public partial class resetJan5 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, false, "Programming Classes (for Rising Stars - IX - XII )" },
                    { 2, false, "Software Engineering .Net Internship - 6 months " },
                    { 3, false, "Software Engineering .Net Internship  -  45 days " },
                    { 4, false, "Cyber Security" },
                    { 5, false, " Game Development" },
                    { 6, false, "Hardware / Networking" },
                    { 7, false, "Others" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Applications",
                columns: new[] { "UniqueId", "Address", "ApplicationId", "AppliedOn", "CollegeName", "CourseId", "EmailId", "ErrorLogDuringStudentGenration", "FatherName", "FirstName", "HighestQualification", "LastName", "Message", "MobileNumber", "StatusId" },
                values: new object[,]
                {

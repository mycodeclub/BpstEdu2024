...
namespace BpstEducation.Areas.Admin.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? batchId)
        {
            ...
            if (batchId.HasValue)
            {
                // Join BatchStudent to filter students by Batch
            var students1 = students.Where(s => _context.BatchStudents
                    .Any(bs => bs.StudentId == s.UniqueId && bs.BatchId == batchId.Value));
            }
